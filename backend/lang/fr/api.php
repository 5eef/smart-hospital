...
return [
    ...
    'appointment_transition_invalid' => 'Cette transition de rendez-vous n’est pas autorisée.',
    'department_unavailable' => 'Le département sélectionné n’est pas actif.',
    'patient_unavailable' => 'Le compte patient sélectionné n’est pas actif.',
    'appointment_future_required' => 'Un rendez-vous replanifié doit rester dans le futur.',
    'prescription_archived_record' => 'Une prescription ne peut pas utiliser un dossier archivé.',
    'prescription_inconsistent' => 'Le dossier médical, le patient et le médecin de la prescription sont incohérents.',
    'stale_record' => 'Cette ressource a été modifiée entre-temps. Rechargez-la avant de réessayer.',
    'clinical_order_transition_invalid' => 'Cette transition d’ordre clinique n’est pas autorisée.',
    'too_many_attempts' => 'Trop de tentatives. Réessayez plus tard.',
    'password_reset_link_sent' => 'Le lien sécurisé a été envoyé.',
    'password_reset_link_failed' => 'Le lien sécurisé n’a pas pu être envoyé.',
    'profile' => [
